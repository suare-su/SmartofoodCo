...
tips = [
    {
        ...
        'sum': 13,
        'paymentTypeId': '9921ba7d-088e-4ae1-85ff-d8697b8f869a'
...
tips = [
    {
        ...
        'tipsTypeId': '0ef8fb9a-57aa-f746-0181-908bfcb8529b',
        'sum': 14,
        'paymentTypeId': 'f9053900-5c5d-4963-a2d5-c45fe56a0baa'
...
create_order_url = 'https://api-eu.iiko.services/api/1/order/create'
...
print('--------------order status--------------')
#"orderInfo": {"id": "53836009-c235-4067-a48c-61f4295a4a36"